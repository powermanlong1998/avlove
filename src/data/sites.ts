    ...
    sites: [
      {
        ...
        icon: '🎨',
        color: 'teal',
        url: 'https://www.mitaobobo05.top/',
        publishUrl: 'https://www.mtbb.me/',
        loginUrl: 'https://8jjl.cid3r7.com/thread.php?fid=389',
        account: 'long1998x',
        password: 'QAZwsx1998520',
        description: '蜜桃啵啵 2048论坛获取资源',
      },
      {
        slug: '微密猫',
        name: '微密猫',
        ...
        icon: '🌟',
        color: 'red',
        url: 'https://weimimao02.net/',
        publishUrl: 'https://weimimao99.net/',
        loginUrl: 'https://weimimao02.net/',
        account: 'long1998x',
        password: 'QAZwsx1998520',
        description: '微密猫',
      },
